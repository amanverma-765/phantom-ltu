...
sealed interface MapPickerUiEvent {
    ...
    data class SearchLocation(val query: String, val field: RouteField = RouteField.ORIGIN) : MapPickerUiEvent
    data class SelectSearchResult(val placeId: String, val field: RouteField = RouteField.ORIGIN) : MapPickerUiEvent
    data object ClearSearch : MapPickerUiEvent
    data object ClearRoute : MapPickerUiEvent
